...
- [x] DevOps - это подход к разработке, при котором разработчики и системные администраторы синхронизируют работу, чтобы быстрее и надёжнее выпускать обновления и приложения.
- [x] MLOps - способ удобно и безопасно работать с ML-моделями: обучать, обновлять, запускать в продакшне и следить, чтобы они не "ломались" со временем.
- [x] git - система контроля версий.
- [x] Data Sciense - общие вопросы по тому кто такой специалист Data Sciense, чем он занимается, как им стать и т. д. 
